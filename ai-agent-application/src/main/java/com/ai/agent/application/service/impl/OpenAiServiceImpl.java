...
public class OpenAiServiceImpl implements LlmService {
    ...
    public LlmResponse chat(LlmRequest request) {
        ...
        LlmResponse result = AppRetryUtil.retry(() -> {
            ...
            try (Response response = okHttpConfig.getClientByPlatform("openai").newCall(okRequest).execute()) {
            ...
            streamExecutor.submit(() -> {
                ...
                try {
                    ...
                    Response response = AppRetryUtil.retryForStream(() -> {
                        Response resp = okHttpConfig.getClientByPlatform("openai").newCall(okRequest).execute();
