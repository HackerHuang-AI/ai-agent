...
public class MoonshotServiceImpl implements LlmService {
    ...
    public LlmResponse chat(LlmRequest request) {
        ...
        LlmResponse result = AppRetryUtil.retry(() -> {
            ...
            try (Response response = okHttpConfig.getClientByPlatform("moonshot").newCall(okRequest).execute()) {
        ...
        }, retryConfig.getRetryParam("moonshot"));
            ...
            streamExecutor.submit(() -> {
                ...
                try {
                    ...
                    Response response = AppRetryUtil.retryForStream(() -> {
                        Response resp = okHttpConfig.getClientByPlatform("moonshot").newCall(okRequest).execute();
