...
| 参数 | OpenAI | Deepseek | Qwen | 豆包 | Minimax | 智谱 | Moonshot | Ollama |
|------|--------|----------|------|------|---------|------|----------|--------|
| `model` | 模型名 | 模型名 | 模型名 | **endpoint_id** | 模型名 | 模型名 | 模型名 | 模型名 |
| `messages` | ✅ | ✅ | ✅ | ✅ | ✅（结构略不同） | ✅ | ✅ | ✅ |
| `stream` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| `temperature` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| `max_tokens` | ✅ | ✅ | ✅ | ✅ | `tokens_to_generate` | ✅ | ✅ | `num_predict` |
| `top_p` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| `tools` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 平台特有扩展 | — | `reasoning_content` | `enable_search` | — | `bot_setting` | — | — | `keep_alive` / `options` |
