...
import com.ai.agent.application.service.impl.DeepseekServiceImpl;
...
public class DeepseekChatController {
    ...
    public DeepseekChatController(DeepseekServiceImpl deepseekService) {
    ...
    public Result<LlmResponseVO> chat(@Valid @RequestBody LlmRequestVO req) {
        ...
        try {
            LlmResponse response = deepseekService.chat(toServiceRequest(req));
    ...
    public SseEmitter chatStream(@Valid @RequestBody LlmRequestVO req) {
        ...
        deepseekService.chatStream(toServiceRequest(req), buildSseConsumer(emitter, req.getModelCode()));
        return emitter;
    }
